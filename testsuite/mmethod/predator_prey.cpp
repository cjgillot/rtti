...
BOOST_MMETHOD_DECLARE(hunter, ResultType, ( _v<Predator_abstract const&>, _v<Prey_abstract const&> ));
//]
...
BOOST_MMETHOD_IMPLEMENT(hunter, ResultType, ( Lion const& pred, Gazelle const& prey ))
{
  //=std::cout<<"Lion jumps on Gazelle and bites its neck.\n";
}
 
BOOST_MMETHOD_IMPLEMENT(hunter, ResultType, ( Lion const& pred, Giraffe const& prey ))
{
  //=std::cout<<"Lion jumps on Giraffe and bites its ass.\n";
}

BOOST_MMETHOD_IMPLEMENT(hunter, ResultType, ( Anaconda const& pred, Gazelle const& prey ))
{
  //=std::cout<<"Anaconda injects venom into Gazelle.\n";
}

BOOST_MMETHOD_IMPLEMENT(hunter, ResultType, ( Anaconda const& pred, Giraffe const& prey ))
{
  //=std::cout<<"Anaconda ignores Giraffe.\n";
}

//` We can catch all the preys using a `Prey_abstract` argument.
BOOST_MMETHOD_IMPLEMENT(hunter, ResultType, ( Bear const& pred, Prey_abstract const& prey ))
{
