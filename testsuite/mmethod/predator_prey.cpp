...
BOOST_MMETHOD_IMPLEMENT(hunter, ResultType, ( Lion const&, Gazelle const& ))
{
  //=std::cout<<"Lion jumps on Gazelle and bites its neck.\n";
}
 
BOOST_MMETHOD_IMPLEMENT(hunter, ResultType, ( Lion const&, Giraffe const& ))
{
  //=std::cout<<"Lion jumps on Giraffe and bites its ass.\n";
}

BOOST_MMETHOD_IMPLEMENT(hunter, ResultType, ( Anaconda const&, Gazelle const& ))
{
  //=std::cout<<"Anaconda injects venom into Gazelle.\n";
}

BOOST_MMETHOD_IMPLEMENT(hunter, ResultType, ( Anaconda const&, Giraffe const& ))
{
  //=std::cout<<"Anaconda ignores Giraffe.\n";
}

BOOST_MMETHOD_IMPLEMENT(hunter, ResultType, ( Bear const&, Prey_abstract const& prey ))
{
