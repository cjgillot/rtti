...
using tags::_v;
DECLARE_MMETHOD(f1, int, (long, _v<foo const&>));

IMPLEMENT_MMETHOD(f1, int, (long n, foo const& a)) { return n + a.f(); }
IMPLEMENT_MMETHOD(f1, int, (long n, bar const& a)) { return n + a.g(); }
IMPLEMENT_MMETHOD(f1, int, (long n, baz const& a)) { return n * a.f(); }
