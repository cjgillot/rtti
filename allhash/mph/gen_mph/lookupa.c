...
--------------------------------------------------------------------
Modified 08/10/2012 by Camille Gillot -> add 64-bit version based on
...
register ub8  level;    /* the previous hash, or an arbitrary value */
{
   ...
   case 22: c+=((ub8)k[10]<<48);
   case 21: c+=((ub8)k[10]<<40);
   case 20: c+=((ub8)k[10]<<32);
   case 19: c+=((ub8)k[10]<<24);
   case 18: c+=((ub8)k[10]<<16);
   case 17: c+=((ub8)k[10]<<8);
      /* the first byte of c is reserved for the length */
